...
<div class="container-1500" style="margin-left: 50px;">
       ...
       <form action="delete" method="post" class="delete_form">
    	...
    	<div class="row" style="margin:auto;">
			<a class="link" href="${pageContext.request.contextPath}/admin/order/list">최신순</a>
			<a class="link" href="${pageContext.request.contextPath}/admin/order/list?sort=order_date asc">오래된순</a>
			<a class="link" href="${pageContext.request.contextPath}/admin/order/list?sort=total desc">높은 주문액순</a>
			<a class="link" href="${pageContext.request.contextPath}/admin/order/list?sort=total asc">낮은 주문액순</a>
		</div>
		...
		<div class="page_wrap">
			<div class="page_nation">
				...
				<a class="arrow prev" href="${pageContext.request.contextPath}/admin/order/list?page=${vo.prevPage}">&lt;</a>
				</c:if>
					<c:forEach var="i" begin="${vo.startBlock}" end="${vo.finishBlock}">
						<a href="${pageContext.request.contextPath}/admin/order/list?page=${i}&keyword=${keyword}&sort=${sort}">${i}</a>
					</c:forEach>
				<c:if test="${vo.page != vo.totalPage}">
				<a class="arrow next" href="${pageContext.request.contextPath}/admin/order/list?page=${vo.nextPage}">&gt;</a>
				</c:if>
			</div>
		</div>
    </div>
