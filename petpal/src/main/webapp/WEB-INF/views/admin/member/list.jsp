...
<jsp:include page="/WEB-INF/views/template/adminHeader.jsp"></jsp:include>
	...
	$(function(){
       ...
       <!-- 정렬  -->
	   	<div class="row ms-10">
			<a class="link" href="${pageContext.request.contextPath}/admin/member/list?">최신 가입일순</a>
                ...
                <tbody>
                	<c:forEach items="${memberList}" var="list">
	                    <tr class="center">
	                        ...
	                        <td>
	                        	<a class="link" href="${pageContext.request.contextPath}/admin/member/detail?memberId=${list.memberId}">상세</a>
	                        	<a class="link" href="${pageContext.request.contextPath}/admin/member/edit?memberId=${list.memberId}">수정</a>
		...
		<div class="page_wrap">
			<div class="page_nation">
				...
				<a class="arrow prev" href="${pageContext.request.contextPath}admin/member/list?page=${vo.prevPage}">&lt;</a>
				</c:if>
					<c:forEach var="i" begin="${vo.startBlock}" end="${vo.finishBlock}">
						<a href="${pageContext.request.contextPath}/admin/member/list?page=${i}&sort=${sort}">${i}</a>
					</c:forEach>
				<c:if test="${vo.page != vo.totalPage}">
				<a class="arrow next" href="${pageContext.request.contextPath}/admin/member/list?page=${vo.nextPage}">&gt;</a>
				</c:if>
			</div>
		</div>
    </div>
