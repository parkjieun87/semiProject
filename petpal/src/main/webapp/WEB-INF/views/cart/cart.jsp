        ...
        <div class="row">
           <table>
           	...
           	<tr class="" cart-idx="" cart-quantity="1" goods-mixsno="" goods-viewcode="">
                 ...
                 <span id="spans"> <a href="/product/P000010819">${list.productName}</span> (묶음1개)                                                       </a>
                      </div>
                     </th>
           ...
           <td>
   			 <div class="row" style="width:100%; display:flex; align-items:center;">
                               <p>가격: <span class="row price spans">${list.productPrice}</span>원</p>
                               <p>수량: <input type="number" name="quantity" value="1" min="1" max="10" onchange="updatePrice(2)" autocomplete="off"> </p>               
		 	</div>
          </td>
          
          <td>
                    <p>품목 가격: <span class="total spans" onchange="updatePrice(2)" autocomplete="off">${list.productPrice}</span>원</p>
           </td>
            <td>
                    <div class="row" style="width:100%; display:flex; align-items:center;">
                               <p>총 가격: <span class="total spans" name="quantity1">10000</span>원</p>      
		 			</div>
