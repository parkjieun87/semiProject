...
<form action="password" method="post" align="center" class="mt-10" >
	...
	<button class="form-btn positive w-50" onclick="location.href='${pageContext.request.contextPath}/member/passwordFinish'">비밀번호 변경</button>
