...
<div class="container-600">
    ...
    <div class="row">
       <label>아이디</label>
      <input type="text" name="memberId" class="form-input w-100" value="${memberDto.memberId}" readonly>
    </div>    
   
   <div class="row">
         <label>비밀번호 확인</label>
          <input type="password" name="memberPw" required placeholder="확인을 위한 비밀번호 입력" class="form-input w-100">   
   </div>
   <div class="row">
      <label>닉네임<i class="fa-solid fa-asterisk"></i></label>
      <input type="text" name="memberNick" class="form-input w-100" value="${memberDto.memberNick}">
   ...
   <div class="row">
      <input type="tel" name="memberTel" class="form-input w-60" id="phone"placeholder="대시(-)를 제외하고 작성" value="${memberDto.memberTel}">
